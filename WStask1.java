	...
	public void task1() throws InterruptedException {
		...
		for (String ch: parentChildIds ) {
			...
			if(!parentId.equals(ch)) {
				...
				Thread.sleep(3000);
				WebElement search = d.findElement(By.xpath("//input[@class='gLFyf gsfi']"));
				search.sendKeys("bts images");
				Thread.sleep(3000);
				
				WebElement searchBt = d.findElement(By.xpath("//input[@class='gNO89b']"));
				searchBt.click();
				Thread.sleep(3000);
		...
		Thread.sleep(3000);
        WebElement y = d.findElement(By.xpath("//a[@class='post-count-link']"));
        y.click();
        Thread.sleep(3000);
        d.quit();
